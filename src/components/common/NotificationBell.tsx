...
export default function NotificationBell() {
    const { notifications, unreadCount, markAsRead, markAllAsRead, respondToUpdate } = useNotifications();
    const [open, setOpen] = useState(false);

    return (
        <BellWrapper>
            <BellButton onMouseDown={(e) => e.stopPropagation()} onClick={() => setOpen((v) => !v)} aria-label="알림">
